...
DROP TABLE IF EXISTS AR_DIRBA_VISAS_PARAS;
...
INSERT INTO AR_DIRBA_VISAS_PARAS(id_AR_DIRBA_VISA_PARA, name) VALUES(1, 'Taip');
INSERT INTO AR_DIRBA_VISAS_PARAS(id_AR_DIRBA_VISA_PARA, name) VALUES(2, 'Ne');
...
(
	...
	Fiksuota_alga decimal NOT NULL,
...
(
	...
	Savininko_asmens_kodas int NOT NULL,
	Amzius int NOT NULL,
	Banko_saskaita varchar (255) NOT NULL,
	Adresas varchar (255) NOT NULL,
	Lytis integer NOT NULL,
	PRIMARY KEY(Savininko_asmens_kodas),
...
(
	...
	fk_SAVININKASSavininko_asmens_kodas int NOT NULL,
	PRIMARY KEY(id_SPORTO_SALE),
	FOREIGN KEY(Ar_dirba_visa_para) REFERENCES AR_DIRBA_VISAS_PARAS (id_AR_DIRBA_VISA_PARA),
	CONSTRAINT valdo FOREIGN KEY(fk_SAVININKASSavininko_asmens_kodas) REFERENCES SAVININKAI (Savininko_asmens_kodas)
);
...
(
	Vardas varchar (255) NOT NULL,
	Pavarde varchar (255) NOT NULL,
	Darbuotojo_asmens_kodas int NOT NULL,
	Banko_saskaita varchar (255) NOT NULL,
	...
	PRIMARY KEY(Darbuotojo_asmens_kodas),
...
(
	...
	Lytis integer NOT NULL,
	id_SPORTO_SALE integer NOT NULL,
	fk_DARBUOTOJASDarbuotojo_asmens_kodas int NOT NULL,
	fk_SPORTO_SUTARTISid_SPORTO_SUTARTIS integer NOT NULL,
	PRIMARY KEY(Asmens_kodas),
	FOREIGN KEY(Lytis) REFERENCES LYTYS (id_LYTIS),
	CONSTRAINT priima FOREIGN KEY(fk_DARBUOTOJASDarbuotojo_asmens_kodas) REFERENCES DARBUOTOJAI (Darbuotojo_asmens_kodas),
...
(
	...
	CONSTRAINT vairuoja FOREIGN KEY(fk_DARBUOTOJASDarbuotojo_asmens_kodas) REFERENCES DARBUOTOJAI (Darbuotojo_asmens_kodas)
);
